...
| 2 | JSON Import/Export 구현 (skill/sequence/affect/condition) | DONE | 4개 파일 읽기/쓰기 버튼 + 라운드트립(불러오기→수정→내보내기) 동작 |
| 3 | 타입별 키 자동 폼 고도화 (eDataInt/Float/String 매핑) | RUNNING | 타입 선택 시 허용 키 자동 표시/입력 검증 + 기본 프리셋 확장 |
